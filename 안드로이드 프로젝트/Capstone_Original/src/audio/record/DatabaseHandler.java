...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "/mnt/sdcard/database/SoundFeatures.db3";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        Log.d("asr", "Features Table Created");
    }
    ...
    public void addFeature(Feature feature) {
    	...
    	try {
    		 SQLiteDatabase db = this.getWritableDatabase();
    	        ...
    	        Log.d("asr", " New feature added");	
		} catch (Exception e) {
			Log.d("asr", " Exception while adding new feature.");	
		}
    ...
    public List<Feature> getAllFeatures() {
    	Log.d("database", "in getAllFeatures");
